...
if (NOT UMBA_TARGET_ARCH)
    ...
    if (UMBA_TARGET_SYSTEM AND NOT UMBA_TARGET_ARCH)
        message(FATAL_ERROR "UMBA: MSVC sln(x) mode: UMBA_TARGET_SYSTEM detected (${UMBA_TARGET_SYSTEM}), but UMBA_TARGET_ARCH - not detected!")
    endif()
endif()
...
if (NOT UMBA_TARGET_ARCH)
    ...
    if (UMBA_TARGET_SYSTEM AND NOT UMBA_TARGET_ARCH)
        message(FATAL_ERROR "UMBA: MSVC cl mode: UMBA_TARGET_SYSTEM detected (${UMBA_TARGET_SYSTEM}), but UMBA_TARGET_ARCH - not detected!")
    endif()
endif()
